---
title: Front Matter — Ratification, Preface, and Table of Contents
edition: "1928"
revision:
tradition: PECUSA
collection: BCP 1928
...
provenance:
  ...
  carried_forward:
    ...
    - edition: "1928"
      ...
      status: complete
    - edition: "1979"
      ref: "[[../1979/00_front-matter]]"
      ref_interim:
      status: pending-copyright
  modified_in: "1928"
  dropped_in:
  notes: Contains three distinct documents of different provenance. The Ratification was adopted October 16, 1789 by the first General Convention and has appeared unchanged in every PECUSA edition since. The Preface was written in Philadelphia, October 1789, and likewise carried forward essentially unchanged. The Table of Contents and Certificate of Conformity reflect the specific 1928 edition — the certificate exists in two versions, 1929 (Robinson) and 1945 (Suter), reflecting the two printings of the 1928 BCP.
category: front-matter
subcategory: prefatory
page_ref: iv
liturgical_season:
liturgical_color:
sunday_normalized:
...
modern_equivalent: BCP 1979 pp. 7–11
language: en
...
> **Note:** Pagination in the Ordinal and onwards differs in editions 
> before 1945 from that here due to the use of smaller type in those 
> earlier editions.
